 ...
 * dsh-better-sidebar core applies). Host-header loopback or a configured
...
export function isTrustedApiRequest(request: ApiTrustRequest, trustedHosts: readonly string[]): boolean {
  ...
  // the port, and refusing those bricks every plugin route. Absent Origin is
  // fine — the Host fence above already bound the request. The literal
